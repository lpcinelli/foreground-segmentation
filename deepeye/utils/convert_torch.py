        ...
        if name == 'SpatialConvolution' or name == 'nn.SpatialConvolutionMM':
            ...
            s += [
                'nn.Conv2d({},{},{},{},{},{},{},bias={}),#Conv2d'.format(
                    ...
                    (m.padW, m.padH), 1, m.groups, m.bias is not None)
            ]
        elif name == 'SpatialBatchNormalization':
            s += [
            ...
            s += [
                'nn.ConvTranspose2d({},{},{},{},{},{})'.format(
                    m.nInputPlane, m.nOutputPlane, (m.kW, m.kH), (m.dW, m.dH),
                    (m.padW, m.padH), (m.adjW, m.adjH))
            ]
        elif name == 'VolumetricFullConvolution':
            s += [
                'nn.ConvTranspose3d({},{},{},{},{},{},{})'.format(
                    m.nInputPlane, m.nOutputPlane, (m.kT, m.kW, m.kH),
                    (m.dT, m.dW, m.dH), (m.padT, m.padW, m.padH),
                    (m.adjT, m.adjW, m.adjH), m.groups)
            ]
        elif name == 'SpatialReplicationPadding':
            s += [
                'nn.ReplicationPad2d({})'.format((m.pad_l, m.pad_r, m.pad_t,
                                                  m.pad_b))
            ]
        elif name == 'SpatialReflectionPadding':
            s += [
                'nn.ReflectionPad2d({})'.format((m.pad_l, m.pad_r, m.pad_t,
                                                 m.pad_b))
            ]
        elif name == 'Copy':
            ...
            lrn = 'lnn.SpatialCrossMapLRN(*{})'.format((m.size, m.alpha,
                                                        m.beta, m.k))
            s += [
            ...
            s += [
              ...
              or name == 'nn.SpatialUpSamplingBilinear'):
            if m.oweight is None or m.owidth is None:
                s += [
                    'nn.UpSample(size=None, scale_factor={}, mode="bilinear")'.
                    format(m.scale_factor)
                ]
            else:
                s += [
                    'nn.UpSample([{}, {}], {}, mode="bilinear")'.format(
                        m.oheight, m.owidth, m.scale_factor)
                ]
        elif name == 'Sequential':
            ...
            dim = m.dimension
            s += [
                'LambdaReduce(lambda x,y,dim={}: torch.cat((x,y),dim)'
                ', # Concat'.format(m.dimension)
            ]
            s += lua_recursive_source(m)
            s += [')']
        else:
